...
`r chunk_reveal("facets", break_type = "rotate", width_code = "54%", width_output = "45%")`
...
gapminder %>% 
  ...
  facet_wrap(vars(continent), scales = "free", switch = "x") + #ROTATE
...
`r chunk_reveal("categorical_free")`

```{r categorical_free, include = F}
...
`r chunk_reveal("matrix", width_code = "59%", width_output = "40%")`
