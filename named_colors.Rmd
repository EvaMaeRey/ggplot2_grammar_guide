...
*Base R contains 657 different color names that can be used to get colors; those names can retrieved with the `colors()` function.  There are some names that refer to the same color like "gray" and "grey", and "bisque" and "bisque1".  Most names and corresponding colors are listed here alphabetically, except for greys/grays which are show at the bottom.  A few named colors are not reproduced here.*  
