...
ggplot(by_month) +
  ...
  labs(subtitle = "Number of role call votes by month, 1946-2015") +
  labs(caption = "Data: Erik Voeten Data and Analyses of Voting in the UN General Assembly\nvia unvotes package in R\nViz: @evamaerey w ggplot2") +
