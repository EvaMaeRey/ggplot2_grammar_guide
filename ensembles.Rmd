...
```{r, echo = F, out.height="80%", include=F}
knitr::include_graphics("../../teaching/lecture_topics/images_for_lecture/malaria_cases.png")
```
Composing plots or ensembles can help you tell a fuller picture of your data. External packages cowplot and patchwork are demonstrated here.  Try to be consistent with encoding of color, linetype, shape across plots!
...
`r chunk_reveal("patch", break_type = "rotate", widths = c(59,40))`
...
`r chunk_reveal("cow2", widths = c(59, 40))`
...
`r chunk_reveal("image", widths = c(59,40))`
...
A final topic coming up is [concision](concision.html).  Some strategies for not repeating yourself and a few other topics.
