...
`r chunk_reveal("time_series_build", widths = c(59, 40))`
...
`r chunk_reveal("time_series", break_type = "rotate", widths = c(59, 40))`
...
`r chunk_reveal("jagged", break_type = "rotate", widths = c(49, 50))`
...
`r chunk_reveal("circle_pack", widths = c(49, 50))`
...
`r chunk_reveal("treemapify", widths = c(49, 50))`
...
`r chunk_reveal("single_value", break_type = "rotate", widths = c(49, 50))`
...
`r chunk_reveal("single_value2", break_type = "rotate", widths = c(49, 50))`

```{r single_value2, include=F}
gapminder %>% 
  filter(year == 2002) %>% 
  filter(continent == "Europe") %>% 
  ggplot() +
...
Installation of waffles package doesn't work from CRAN. Use this:
...
`r chunk_reveal("waffle", widths = c(49, 50))`
