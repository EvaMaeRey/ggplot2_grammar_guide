...
`r chunk_reveal("univariate_continuous_build", width_code = "59%", width_output = "40%")`
...
`r chunk_reveal("univariate_continuous", break_type = "rotate", width_code = "59%", width_output = "40%")`
...
`r chunk_reveal("geom_discrete_continuous_facet_build", width_code = "59%", width_output = "40%")`
...
`r chunk_reveal("geom_discrete_continuous_facet", break_type = "rotate", width_code = "59%", width_output = "40%")`
...
`r chunk_reveal("geom_discrete_continuous_build", width_code = "59%", width_output = "40%")`
...
`r chunk_reveal("geom_discrete_continuous", break_type = "rotate", width_code = "59%", width_output = "40%")`
...
`r chunk_reveal("geom_discrete_continuous_bee", break_type = "rotate", width_code = "59%", width_output = "40%")`
