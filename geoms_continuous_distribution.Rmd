...
gapminder %>% 
  ...
  ggpol::geom_boxjitter(alpha = 0.3) + #ROTATE
  ggpol::geom_boxjitter(aes(color = continent), alpha = 0.3) + #ROTATE
  ggpol::geom_boxjitter(aes(color = higher_income), alpha = 0.3) + #ROTATE
  ggpol::geom_boxjitter(jitter.colour = "steelblue2", errorbar.draw = TRUE) #ROTATE
```
