...
Many thanks to Yihui Xie and coauthors of the Xaringan tool.  Thanks to Emi Tanaka and Garrick Aden-Buie for their invaluable contributions to getting automated side-by-side code-output evolution (flipbook) going.  Thanks to Will Chase for seeding a valuable discussion about challenges of ggplot2. 

MPI Dresden July 18 workshop organizer Ulirk Günther and participant for their interest in R and ggplot2 for motivation and their great discussion and questions.

Finally, thanks to the [ggplot2](https://ggplot2.tidyverse.org/reference/) team Hadley Wickham, Kara Woo, Claus Wilke, Thomas Pederson for building and maintaining a cool tool. 
...
0. [The Declarative mood: declaring data](#data)
1. [The Interogative mood: aesthetic mapping aes()](#aes)
1. [Modifiers: scales, scale_\*_\*()](#scales)
1. [Modifiers II: labs, labs()](#labs)
1. [Nouns: geom_*()](#geoms)
1. [Conditional mood: aesthetics | geom, i.e. - going local](#local)
  - mapped aesthetics tied to a specific geom
  - unmapped aesthetics, (the Imparative mood)
  - specifying local data
1. [Exclamations and Interjections: annotate(geom = "*")](#annotation)
1. [Punctuation: facets](#facets)
1. [Translation: coords, coord_*()](#coords)
1. [Greetings: theme_*()](#themes)
...
ggplot2 is an implementation of the "grammar of graphics" for R.  The grammar of graphics is a philosophy that enables users to go beyond fixed chart types by mapping variabls in data to aesthetics of geometric objects.  
...
> With ggplot2, you can do more faster by learning one system and applying it in many places. (R4DS)
...
# Modifiers: Asking for more with scales\_\*\_\* 
...
# Modifiers II:  Asking for more -- Fine tuning labels
...
# The conditional tense: geom specific data, aesthetic mapping, and unmapped aesthetics
...
## Using polar coordinates: a pie chart
...
- [the ggplot2 website](https://ggplot2.tidyverse.org/reference/)
- [RStudio Cheat Sheets](https://www.rstudio.com/resources/cheatsheets/) include ones on ggplot2 and data wrangling
...
# Why doesn't my code doesn't look like other examples I've seen?

This book uses a "slow ggplot" style, which is a bit verbose and is not all that typical. More often, you will global aesthetics tucked together in the ggplot statement. Also, labs statements will typically be nested together. Finally, you might not see every parameter spelled out, rather position in the function is used to indicate the parameters. 
