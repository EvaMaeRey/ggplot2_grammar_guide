...
Many thanks the authors of the Xaringan slide show tool.  Thanks to Emi Tanaka and Garrick Aden-Buie for their invaluable contributions to getting automated side-by-side code-output evolution (flipbook) going.  Thanks to Will Chase for seeding a valuable discussion about challenges of ggplot2. 
...
Finally, thanks to the [ggplot2](https://ggplot2.tidyverse.org/reference/) team building and maintaining an amazing tool. 
...
1. [The Interogative mood: aesthetic mapping aes()](#aes)
  - [Modifiers: scales, scale\_**aes**\_\*()](#scales)
  - [Modifiers II: labels, labs(**aes** = ...)](#labs)
  - [Modifiers III: coordinate systems, coord\_\*()](#coords)
1. [Nouns: geometric objectsgeom_*()](#geoms)
