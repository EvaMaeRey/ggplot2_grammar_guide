...
9. **Composition** | *library(patchwork) <br> (g1 + g2) \| g3 <br> <br> library(cowplot) <br> plotgrid(...,)* | [create ensembles](ensembles.html){target="_blank"}
...
- [continuous - continuous](geoms.html#cc){target="_blank"} `r build_and_use_gif(path = p, pattern = "continuous_continuous")`
...
- [continuous - discrete](geoms.html#cd){target="_blank"} `r build_and_use_gif(path = p, pattern = "geom_discrete_continuous")`
- [discrete - continous, single value](){} `r build_and_use_gif(path = p, pattern = "single_value")`
- [discrete - discrete](geoms.html#dd){target="_blank"} `r build_and_use_gif(path = p, pattern = "discrete2x")`
- [single series]  `r build_and_use_gif(path = p, pattern = "time_series_ro")`
- [series - multi]  `r build_and_use_gif(path = p, pattern = "time_series_multi")`
...
- [geom_sf](https://evamaerey.github.io/flipbooks/geom_sf/geom_sf#1){target="_blank"}
- [tmap](tmap.html){target="_blank"}


Network

- [An example](https://evamaerey.github.io/flipbooks/the_office/the_office.html#81)

---

- [ggtext](https://evamaerey.github.io/flipbooks/ggtext/ggtext){target="_blank"}
