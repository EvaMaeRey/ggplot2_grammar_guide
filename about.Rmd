...
7. **Greetings**| [**themes** changing plot look and feel](themes.html){target="_blank"}   | `r viztoc:::build_and_use_gif(dir = "themes_files/figure-html/", pattern = "", href = "themes.html", which = 48, width = 100, height = 100, cached_gif = T, delay = .22)` | *theme_minimal()*
