...
select_static <- function(path, pattern){
...
use_gif <- function(gif_file){
  
  knitr::include_graphics(path = gif_file)
  
}


use_static_and_gif <- function(static_file, gif_file){
...
build_and_use_gif <- function(path, 
  ...
  use_static_and_gif(static_file = static_file,
                     gif_file = gif_file)
...
**Homer dips his toe into some Data Vis! Leaving him here just for Data Viz Spring 2020!**
...
7. **Greetings**|*theme_minimal()* | [**themes** changing plot look and feel](themes.html){target="_blank"}
...
- [continuous X continuous](geoms.html#cc){target="_blank"} `r build_and_use_gif(path = p, pattern = "continuous_continuous")`
- [univaritate continuous](geoms.html#c){target="_blank"} `r build_and_use_gif(path = p, pattern = "univariate_continuous")`
- [1 discrete](geoms.html#d){target="_blank"}
- [continuous X discrete](geoms.html#cd){target="_blank"} `r build_and_use_gif(path = p, pattern = "geom_discrete_continuous")`
- [discrete X continous, single value](){} `r build_and_use_gif(path = p, pattern = "single_value")`
- [discrete X discrete](geoms.html#dd){target="_blank"} `r build_and_use_gif(path = p, pattern = "discrete2x")`
- [single series](geoms.html#single_series)  `r build_and_use_gif(path = p, pattern = "time_series_ro")`
- [multi series](geoms.html#mult_series)  `r build_and_use_gif(path = p, pattern = "time_series_multi")`
