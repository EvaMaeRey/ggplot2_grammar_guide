...
|| ) + |
5. **Interjections**| *annotate(geom = "point", <br> x = 10, <br> y = 12, <br> color = "blue")* | [Adding context with **annotation layers**](annotate.html){target="_blank"}
6. **Punctuation**  | *facet_wrap(~continent)*| [**faceting** breaks a plot into small plots (or *"small multiples"*) based on categorical variables ](facet.html){target="_blank"} 
7. **Greetings**|*theme_minimal()* | [**themes** changing plot look and feel](themes.html){target="_blank"} | `r viztoc:::build_and_use_gif(path = "themes_files/figure-html/", pattern = "")`
...
9. **Composition** | *library(patchwork) <br> (g1 + g2) \| g3 <br> <br> library(cowplot) <br> plotgrid(...,)* | [Composing plots into ensembles](ensembles.html){target="_blank"}
...
[A closer look at **geoms**](geoms.html){target="_blank"}

- [continuous X continuous](geoms.html#cc){target="_blank"} `r viztoc:::build_and_use_gif(path = p, pattern = "continuous_continuous")`
- [univaritate continuous](geoms.html#c){target="_blank"} `r viztoc:::build_and_use_gif(path = p, pattern = "univariate_continuous")`
- [1 discrete](geoms.html#d){target="_blank"}
- [continuous X discrete](geoms.html#cd){target="_blank"} `r viztoc:::build_and_use_gif(path = p, pattern = "geom_discrete_continuous")`
- [discrete X continous, single value](){} `r viztoc:::build_and_use_gif(path = p, pattern = "single_value")`
- [discrete X discrete](geoms.html#dd){target="_blank"} `r viztoc:::build_and_use_gif(path = p, pattern = "discrete2x")`
- [single series](geoms.html#single_series)  `r viztoc:::build_and_use_gif(path = p, pattern = "time_series_ro")`
- [multi series](geoms.html#mult_series)  `r viztoc:::build_and_use_gif(path = p, pattern = "time_series_multi")`
