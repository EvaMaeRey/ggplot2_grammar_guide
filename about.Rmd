...
- [single series]  `r build_and_use_gif(path = p, pattern = "time_series_ro")`
- [multi series]  `r build_and_use_gif(path = p, pattern = "time_series_multi")`
...
- [An example with the office data](https://evamaerey.github.io/flipbooks/the_office/the_office.html#81)
