...
`r chunk_reveal("local_data", width_code = "49%", width_output = "50%")`
...
`r chunk_reveal("local_data_filter", break_type = 1, title = "#### Manipulating data locally", width_code = "49%", width_output = "50%")`
...
`r chunk_reveal("local_data_from_global", title = "#### Referring to global data locally using period (.)", break_type = 1, width_code = "49%", width_output = "50%")`
...
`r chunk_reveal("geom_specific_aes_mapping", break_type = "rotate", width_code = "49%", width_output = "50%")`
...
`r chunk_reveal("unmapped_aes", break_type = "rotate", width_code = "59%", width_output = "40%")`
